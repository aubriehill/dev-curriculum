...
/******/ 	return __webpack_require__(__webpack_require__.s = "./js/src/adminkit.js");
/******/ })
/************************************************************************/
/******/ ({
...
/**
 * @file
 * Entry point for all admin theme related js.
 */
__webpack_require__(/*! ./draggable-items */ "./js/src/draggable-items.js");

__webpack_require__(/*! ./entity-browser-improvments */ "./js/src/entity-browser-improvments.js");

__webpack_require__(/*! ./expandable-paragraphs */ "./js/src/expandable-paragraphs.js");

__webpack_require__(/*! ./form-validation */ "./js/src/form-validation.js");

__webpack_require__(/*! ./node-edit-improvements */ "./js/src/node-edit-improvements.js");

/***/ }),

/***/ "./js/src/draggable-items.js":
/*!***********************************!*\
  !*** ./js/src/draggable-items.js ***!
  \***********************************/
/*! no exports provided */
...
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var dragula__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! dragula */ "./node_modules/dragula/dragula.js");
...
function adjustOrder(dragulaObject) {
  ...
  $draggableItems.each(function (i) {
    ...
    const $weightSelect = $(this).children('div').children('div').children('.form-type--select').children('select');
    /* @todo with clao update, this selector does not select anything.
    *    However, this still seems to be functioning. Is it needed? */

    const $weightSelectAjax = $(this).children('.ajax-new-content').children('div').children('div').children('.form-type-select').children('select');
...
function initDraggableItems(draggableItemContainers, context) {
  ...
  let draggedItems = [];
  const item = context.querySelector('.draggable-items-container'); // Initialize dragula on draggable containers.

  const drake = dragula__WEBPACK_IMPORTED_MODULE_0___default()([item], {
  ...
  drake.on('drag', el => {
    ...
    draggedItems = []; // Get id from textarea.
  ...
  dom_autoscroller__WEBPACK_IMPORTED_MODULE_1___default()([window], {
    margin: 70,
    maxSpeed: 14,
    autoScroll: function () {
      // eslint-disable-line object-shorthand
...
/***/ "./js/src/entity-browser-improvments.js":
/*!**********************************************!*\
  !*** ./js/src/entity-browser-improvments.js ***!
  \**********************************************/
/*! no static exports found */
...
Drupal.behaviors.entityBrowserImprover = {
  attach: context => {
    ...
    const $browserSelectors = ['view-entity-browser-image', 'view-entity-browser-remote-video', 'view-entity-browser-video', 'view-entity-browser-svg'];
...
/***/ "./js/src/expandable-paragraphs.js":
/*!*****************************************!*\
  !*** ./js/src/expandable-paragraphs.js ***!
  \*****************************************/
/*! no static exports found */
...
Drupal.behaviors.paragraphsPreviewerImprover = {
  attach: context => {
    ...
    formatParagraphsPreviews($paragraphsPreviews); // Necessary for paragraphs previews behind tabs.
...
Drupal.behaviors.formValidation = {
  attach(context) {
    const inputs = ['.js-form-wrapper'];
    const $input = $(inputs.join(', '), context);
    if (!$input.length) return; // If the required attribute gets added in, make sure the necessary markup is updated.
...
/***/ "./js/src/node-edit-improvements.js":
/*!******************************************!*\
  !*** ./js/src/node-edit-improvements.js ***!
  \******************************************/
/*! no static exports found */
...
Drupal.behaviors.nodeEditImprovements = {
  attach: context => {
    ...
    const openClass = 'meta-open'; // If this is an add page, open the meta drawer.
...
/******/ });
//# sourceMappingURL=adminkit.js.map